...
public class TurnImpl implements Turn {
     ...
     * almacenamiento.
     */
    /*friend*/ static TurnImpl from(int id, LocalDateTime timestamp, String contenttype, String terminalid,
            String textUser, String textModelThinking, String textModel,
            String toolCall, String toolResult, float[] embedding) {
        return new TurnImpl(id, timestamp, contenttype, terminalid, textUser, textModelThinking,
     ...
     */
    /*friend*/ static TurnImpl from(LocalDateTime timestamp, String contenttype, String terminalid,
            String textUser, String textModelThinking, String textModel,
            String toolCall, String toolResult, float[] embedding) {
        return new TurnImpl(-1, timestamp, contenttype, terminalid, textUser, textModelThinking,
                textModel, toolCall, toolResult, embedding);
    }
