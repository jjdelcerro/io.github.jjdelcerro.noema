 ...
 * Ejecuta el comando 'co' (checkout) para sobrescribir el archivo de trabajo
 * actual con una revisión específica del historial.
 */
...
public class FileRecoveryTool extends AbstractAgentTool {
  ...
  public ToolSpecificationBuilder getSpecification() {
    return ToolSpecificationBuilder.create()
            ...
            .addStringParameter("path", "Ruta relativa del archivo a recuperar.")
            .addStringParameter("revision", "Número de revisión a extraer (ej: '1.1', '1.2').");
  }
