...
/**
 * Herramienta que conecta el Agente con el sistema JavaRCS. Permite al LLM
 * consultar el historial de revisiones (autores, fechas y mensajes de commit)
...
public class FileHistoryTool extends AbstractAgentTool {
  ...
  public ToolSpecificationBuilder getSpecification() {
    return ToolSpecificationBuilder.create()
            ...
            .addStringParameter("path", "Ruta del archivo (ej: 'src/Main.java')");
  }
